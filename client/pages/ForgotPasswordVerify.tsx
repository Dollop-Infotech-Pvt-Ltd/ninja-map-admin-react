            ...
            >
                ...
                >
                  {timeLeft > 0 ? (
                    <p className="text-muted-foreground text-sm">
                      Code expires in <span className={`font-mono font-medium ${timeLeft < 60 ? 'text-red-500' : 'text-brand-600'}`}>{formatTime(timeLeft)}</span>
                    </p>
                  ) : (
              ...
              >
                <Button
                  ...
                  whileHover={isComplete && !error && timeLeft > 0 && !isLoading ? { scale: 1.01 } : {}}
                  whileTap={isComplete && !error && timeLeft > 0 && !isLoading ? { scale: 0.99 } : {}}
                >
                  {isLoading ? (
