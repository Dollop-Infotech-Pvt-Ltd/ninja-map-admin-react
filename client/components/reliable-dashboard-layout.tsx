...
export function ReliableDashboardLayout({ children, title }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="relative">
        <div className={`fixed left-0 top-0 z-50 h-full w-72 bg-card border-r border-border transition-transform duration-300 lg:relative lg:translate-x-0 ${
          ...
          {/* Sidebar Navigation */}
          <nav className="flex-1 overflow-y-auto p-4 h-[calc(100vh-200px)]">
